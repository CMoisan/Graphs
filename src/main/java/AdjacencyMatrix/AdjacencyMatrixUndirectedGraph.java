...
public class AdjacencyMatrixUndirectedGraph extends AbstractMatrixGraph<UndirectedNode> implements IUndirectedGraph {
	...
	public void removeEdge(UndirectedNode x, UndirectedNode y) {
		if(isEdge(x,y))
		{
			...
			matrix[y.getLabel()][x.getLabel()] = 0;
		}
	}
	...
	public void addEdge(UndirectedNode x, UndirectedNode y) {		
		x.addNeigh(y, y.getLabel());
		y.addNeigh(x, x.getLabel());
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Is edge : "+am.isEdge(new UndirectedNode(2), new UndirectedNode(5)));
		for(int i = 0; i<3;i++)
